...
{
	import aerys.minko.example.core.edgedetection.shaders.post.AntiAliasingShader;
	...
	public class AntiAliasedOutlineEffect extends OutlineEffect 
	{
		public function AntiAliasedOutlineEffect( 	depthMap	: RenderTarget,
