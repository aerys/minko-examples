package aerys.minko.example.core.lines
{
	...
	public class LinesShader extends Shader
	{
		public function LinesShader(renderTarget	: RenderTarget	= null,
									priority		: Number		= 0.0)
		{
		...
		{
			var lineStart	: SFloat	= getVertexAttribute(LinesGeometry.VERTEX_LINE_START);
			var lineStop	: SFloat	= getVertexAttribute(LinesGeometry.VERTEX_LINE_STOP);
			var lineSpread	: SFloat	= getVertexAttribute(LinesGeometry.VERTEX_LINE_SPREAD);
